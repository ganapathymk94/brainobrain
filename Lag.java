...
public class ConsumerLagService {
    ...
    public Map<String, Object> getConsumerLagForTopic(String topic) {
        Map<String, Object> lagData = new HashMap<>();
    ...
    private long predictLag(String partition) {
        ...
        long movingAverage = history.subList(Math.max(history.size() - 5, 0), history.size()).stream().mapToLong(Long::longValue).sum() / 5;
