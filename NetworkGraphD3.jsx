...
const KafkaNetworkGraphD3Mui = () => {
    ...
    return (
        <Card sx={{ width: 850, margin: "auto", mt: 4, padding: 2 }}>
            <CardContent>
                <Typography variant="h6" align="center">Kafka Topic Network Visualization</Typography>
...
export default KafkaNetworkGraphD3Mui;
